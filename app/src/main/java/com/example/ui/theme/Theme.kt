...
private val LiquidGlassColorScheme = darkColorScheme(
    ...
    primaryContainer = Color(0x35005B8A),
    onPrimaryContainer = Color(0xFFD0F4FF),
    secondary = Color(0xFFBF5AF2), // Electric orchid
    onSecondary = Color(0xFF2C004D),
    secondaryContainer = Color(0x354A126D),
    onSecondaryContainer = Color(0xFFF3D8FF),
    tertiary = Color(0xFFFF375F), // Radiant rose
    onTertiary = Color(0xFF4A0014),
    tertiaryContainer = Color(0x356D0E29),
    onTertiaryContainer = Color(0xFFFFD1DC),
    background = Color.Transparent, // Ethereal animated caustics in LiquidGlassBackground shine through all screens!
    onBackground = Color(0xFFF5F7FA),
    surface = Color(0x18101E36), // Translucent frosted sapphire crystal glass (never turns into opaque white on copy!)
    onSurface = Color(0xFFFFFFFF),
    surfaceVariant = Color(0x22182B48), // Translucent deep sapphire glass
    onSurfaceVariant = Color(0xFFD8E4F8),
    surfaceContainer = Color(0x18101E36),
    surfaceContainerHigh = Color(0x241E3456), // Subtle translucent glass layer
    surfaceContainerHighest = Color(0x3228426C), // Specular highlighted glass layer
    surfaceContainerLow = Color(0x100A1424),
    surfaceContainerLowest = Color(0x08060D18),
    outline = Color(0x5564D2FF), // Crystal border rim
    outlineVariant = Color(0x35BF5AF2)
)
